...
<script lang="ts">
import Todo, { type ITodo } from './TodoItem.vue'
import { defineComponent, ref, reactive } from 'vue'

type TodoFuncion = (todos: ITodo[]) => ITodo[]

type FilterType = 'all' | 'active' | 'completed'

const STORAGE_KEY = 'todos'
const filtersDefinition: { [key in FilterType]: TodoFuncion } = {
...
export default defineComponent({
  ...
  setup() {
    ...
    const todos = reactive(defalutList)
    return {
      todos,
      visibility
    }
  ...
  computed: {
    ...
    filteredTodos() {
      return filtersDefinition[this.visibility](this.todos)
    },
