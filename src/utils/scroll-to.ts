...
const windowWithLegacyRAF = window as Window &
  typeof globalThis & {
...
const requestAnimFrame = (function() {
  return (
    windowWithLegacyRAF.requestAnimationFrame ||
    windowWithLegacyRAF.webkitRequestAnimationFrame ||
    windowWithLegacyRAF.mozRequestAnimationFrame ||
